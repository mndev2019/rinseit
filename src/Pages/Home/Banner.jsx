...
const Banner = () => {
  return (
    <>
      <section className="banner w-full h-screen relative flex items-center lg:px-20">
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-2 h-full items-center">
            <div className="col-span-1 flex flex-col justify-center items-start space-y-5">
              <h1 className="text-white text-[80px] playfair">
                The shine that lasts <span className="text-secondary font-[900]">FOREVER.</span>
              </h1>
              <p className="text-white text-[20px] font-[400] pb-7">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.
              </p>
              <button className='bg-primary rounded-md text-white text-sm py-3 px-8'>
                BOOK NOW
              </button>
              <div className="banner_box bg-white rounded-[10px] px-1 py-2 w-full flex items-center">
