                        ...
                        <div className="lg:col-span-4 col-span-1">
                            <div className="w-full lg:pl-20 p-5">
                                ...
                                <div className="w-full mb-3">
                                    <h1 className='text-black font-semibold text-4xl lg:py-4 py-3 '>Log In</h1>
                                    <p className='lg:text-lg text-sm text-[#ABA9A9]'>Welcome Back! Please Sign In</p>
                                </div>
                                <div className="w-full">
                                    ...
                                    <div className="w-full text-center">
                                        <p className='text-[#ABA9A9] text-xs'>Don’t have an Account ? <Link to='/register' className='text-[#FF914D]'>Register</Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
